...
class CheckFlutterSecureStorage {

  static Future<Check> get() async {
    await _ready();

    String? data = await storage.read(key: 'CheckModel');
  ...
  static Future<void> upsert(Check obj) async {
    ...
    await storage.write(key: 'CheckModel', value: data);
  }

  static Future<void> delete() async {
    await _ready();

    await storage.delete(key: 'CheckModel');
  }
